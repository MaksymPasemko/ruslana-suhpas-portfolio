        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-24 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-4 sm:space-y-5 text-muted-foreground leading-relaxed text-sm lg:text-base">
              <p>
                Я займаюся предметною фотографією та працюю переважно з домашньої студії. Я створюю фотографії продуктів для брендів, інтернет-магазинів та компаній, яким потрібні зрозумілі та акуратні зображення товарів для реклами і сайтів.
              </p>
              <p>
