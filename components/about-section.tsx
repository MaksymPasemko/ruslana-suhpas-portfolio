        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-24 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-4 sm:space-y-5 text-muted-foreground leading-relaxed text-sm lg:text-base">
              <p>
                Я — предметний фотограф, який створює комерційні зображення продуктів через світло, форму та атмосферу. Поєдную технічну точність із творчим підходом, щоб підсилити візуальну цінність продукту.
              </p>
              <p>
                Маю досвід роботи предметним фотографом у Sigma.ua, де створювала візуальний контент для брендів і комерційних задач.
              </p>
              <p>
                 Кожне фото — не лише про вигляд, а про результат.
              </p>
            </div>
