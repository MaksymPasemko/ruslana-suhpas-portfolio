const testimonials = [
  {
    quote:
      "Фотографії пастили виглядають апетитно, акуратно та добре підходять для соцмереж. Дуже задоволені результатом співпраці.",
    author: "Клієнтка бренду",
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-12">
        ...
        <div className="mt-8 sm:mt-16 border border-border p-6 sm:p-8 lg:p-12 bg-surface">
          ...
          <p className="text-muted-foreground leading-relaxed text-sm lg:text-base max-w-3xl">
            Під час співпраці клієнти відзначали стабільну якість фотографій, уважну роботу зі світлом і деталями продукту та зручну комунікацію під час підготовки і проведення зйомок. Частина робіт створювалась для брендів і невеликих виробників, яким важлива стабільність контенту та серійні зйомки продуктів.
          </p>
        </div>
      </div>
    </section>
