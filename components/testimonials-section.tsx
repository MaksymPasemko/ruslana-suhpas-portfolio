const testimonials = [
  {
    quote:
      "Дуже цікаво отримати «інше» бачення своєї праці. Дякую за такий творчий підхід до роботи, цікавий формат і такі апетитні світлини. З свого боку бажаю росту і ще сильніше закохуватись у процес, ти величезний молодець. Дякую за бачення!", author: "Засновник бренду",
